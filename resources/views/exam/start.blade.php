            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    <div class="mb-4">
                        ...
                        <h3 class="font-weight-bold mb-2">{{ $exam->name }}</h3>
                        <p class="text-muted mb-0">Isi data peserta terlebih dahulu. Timer baru dimulai setelah Anda menekan tombol mulai pada halaman soal.</p>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        {{-- <div class="col-md-4">
                            <div class="p-3 border rounded h-100 bg-light">
                                ...
                                <div class="h5 mb-0">Siap dikerjakan</div>
                            </div>
                        </div> --}}
                    </div>
                    ...
                    <form method="POST" action="{{ route('exam.participant.store', $exam) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control form-control-lg" value="{{ old('email', $participant['email'] ?? '') }}" placeholder="nama@email.com" required>
                        </div>

                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit" class="btn btn-primary px-5">Lanjut ke Instruksi</button>
                        </div>
                    </form>
                </div>
            </div>
